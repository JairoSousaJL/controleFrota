...
<body style="background-image:url({{asset('images/bg.png')}}); background-size: 1400px 800px;">
    ...
    <div class="container card bg-redCard mt-5">
        ...
        <hr class="bg-white">
        <form action="{{route('pesquisarClientes')}}" method="POST" autocomplete="off">
            @csrf
            <div class="form-row mt-2">
                <div class="col-md-2">
                    <label class="labelCard" for="consultaCliente">Nome ou Código:</label>
                </div>
                <div class="mb-2 col-md-6">
                    <input type="text" class="form-control form-control-sm" id="consultaCliente" name="consultaCliente" placeholder="Nome, Código ou CPF do Cliente" required>
                </div>
                <div class="mb-2 col-md-2">
                  <button type="submit" class="btn btn-primary btn-sm w-100"> <span class="fas fa-search"></span> Pesquisar</button>
                </div>
                <div class="mb-2 col-md-2">
                    <a href="{{route('clientes')}}" class="btn btn-danger btn-sm w-100"> <span class="fas fa-eraser"></span> Limpar Filtros</a>
                </div>
            </div>
        </form>
    </div>
    <div class="container card bg-redCard mt-3">
        ...
        <table class="table table-bordered table-sm " id="tabelaSearch">
          ...
          <div class="form-row mt-2 justify-content-center">              
              <div class="mb-2 mr-2">
                <button type="button" class="btn btn-warning btn-sm" id="showCliente"> <span class="fas fa-list"></span> Ver</button>
              </div>
              <div class="mb-2 mr-2">
                <a type="button" class="btn btn-success btn-sm" href="{{route('createCliente')}}"><span class="fas fa-save"></span> Novo</a>
              </div>
              <div class="mb-2 mr-2">
    ...
    <script>
      ...
      var btnShowCliente = document.getElementById("showCliente");
      ...
      btnShowCliente.addEventListener("click", function(){
        ...
        let route = "{{route('showCliente', ':codigo')}}".replace(":codigo", codigo);
